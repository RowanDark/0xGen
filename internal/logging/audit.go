...
const (
	...
	EventWorkspaceLifecycle  EventType = "workspace_lifecycle"
	EventWorkspaceMembership EventType = "workspace_membership"
	EventWorkspaceInvite     EventType = "workspace_invite"
	EventCaseShare           EventType = "case_share"
	EventCaseEdited          EventType = "case_edited"
)
